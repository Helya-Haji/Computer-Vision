...
hsv_file = r"C:\Users\Helya\Desktop\git\copmuter vision\objeckt tracking\small object using HSV\hsv_colors.txt"   #  creating Text file to save HSV values and the range
